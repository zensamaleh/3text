...
CREATE INDEX idx_gems_is_public ON public.gems(is_public);
CREATE INDEX idx_datasets_gem_id ON public.datasets(gem_id);
CREATE INDEX idx_chats_gem_id ON public.chats(gem_id);
CREATE INDEX idx_chats_user_id ON public.chats(user_id);
CREATE INDEX idx_embeddings_gem_id ON public.embeddings(gem_id);
CREATE INDEX idx_embeddings_dataset_id ON public.embeddings(dataset_id);
...
-- Embeddings policies
CREATE POLICY "Users can manage embeddings of their gems" ON public.embeddings
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.gems 
